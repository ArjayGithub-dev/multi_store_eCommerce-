...
function sendEmailVerification($userEmail, $token)
{
    ...
    <body>
      <div class="wrapper">
        <a href="http://localhost/handmade_treasure_store-main/verifyCustomerEmail.php?token=' . $token . '" style="color: #107869; background: white; border: 1px solid #107869; border-radius: 2px; ">Verify Email!</a>
    </body>
